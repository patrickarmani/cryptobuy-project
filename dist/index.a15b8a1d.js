...
document.addEventListener("DOMContentLoaded", function() {
    ...
    /*signupBox.id = "signup-box";*/ signupBox.id = "signup-box";
    signupBox.innerHTML = `
        <h2>Sign Up For Our Newsletter</h2>
        <p>Sign up for our newsletter to receive information about cryptocurrencies.</p>
        <p>Stay on top of your values \u{200B}\u{200B}and where to buy. Receive exclusive links.</p>
        <form id="signup-form">
...
//# sourceMappingURL=index.a15b8a1d.js.map
